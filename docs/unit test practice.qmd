...
source(here::here("src","foodcartfunctions.R")) #puts function into our global enviro!
#sourcing can run an entire script and put everything made into our local enviro and workflow
...
#call function
height_t2(3, 1, 5) #it works! we didn't even write it ourselves
```
